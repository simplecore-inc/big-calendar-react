      ...
      <Popover.Trigger asChild>
        <Button
          ...
          className={cn(
            ...
            "data-[invalid=true]:border-error-500 data-[invalid=true]:bg-error-50 data-[invalid=true]:focus-visible:outline-error-300 data-[invalid=true]:pr-9",
            "dark:data-[invalid=true]:border-error-900 dark:data-[invalid=true]:focus-visible:outline-error-950 dark:data-[invalid=true]:bg-red-950/20",
            className
          )}
          {...props}
        >
          ...
          <div className="text-error-600 pointer-events-none absolute inset-y-0 end-0 hidden items-center justify-center pr-3 group-data-[invalid=true]:flex">
